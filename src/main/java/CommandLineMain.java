...
public class CommandLineMain {
    ...
    private static void printHelp() {
        ...
        System.out.println("  add-h <x> <y> <name> <capacity>");
        System.out.println("  remove-h <id>");
        System.out.println("  move-h <id> <x> <y>");
        System.out.println("  list-h");
        System.out.println("  stats <id>");
        System.out.println("  nearest <x> <y>");
        System.out.println();
        System.out.println("  USERS");
        System.out.println("  add-u <x> <y>");
        System.out.println("  remove-u <id>");
        System.out.println("  move-u <id> <x> <y>");
        System.out.println("  random-u <count>");
